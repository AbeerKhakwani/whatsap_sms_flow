...
const SHOPIFY_SHOP = process.env.SHOPIFY_SHOP || 'ba42c1.myshopify.com';
const SHOPIFY_ACCESS_TOKEN = process.env.SHOPIFY_ACCESS_TOKEN;
const GRAPHQL_ENDPOINT = `https://${SHOPIFY_SHOP}/admin/api/2024-01/graphql.json`;
...
async function shopifyGraphQL(query, variables = {}) {
  ...
  if (result.errors) {
    ...
    throw new Error(`Shopify GraphQL error: ${result.errors[0]?.message || 'Unknown error'}`);
  }
