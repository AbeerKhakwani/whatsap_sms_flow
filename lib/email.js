 ...
 */
export function payoutNotificationEmail(sellerName, productTitle, amount, notes, screenshotUrl) {
  return {
...
export function payoutReceiptEmail(sellerName, productTitle, { salePrice, discount = 0, platformFee = 10, commissionRate, sellerPayout, method, handle }) {
