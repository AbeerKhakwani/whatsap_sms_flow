...
Example: 85 or $85`,
    ...
    SELL_ASK_DETAILS: `Any details buyers should know? 📝

• Missing buttons, hooks, or embellishments?
• Any stains, tears, or alterations?
• Material? (chiffon, lawn, silk, etc.)
• Extra notes?

Reply SKIP if none, or type the details!`,
...
• Price: $${listing.asking_price_usd || 'Not set'}${listing.details ? `\n• Details: ${listing.details}` : ''}
